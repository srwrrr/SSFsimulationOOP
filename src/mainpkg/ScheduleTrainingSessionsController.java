 ...
 * @author Lovely
 */
public class ScheduleTrainingSessionsController implements Initializable {
    ...
    private void BackButtonOnClick(ActionEvent event) throws IOException {
        Parent prnt = FXMLLoader.load(getClass().getResource("TrainingInstructorDashboard.fxml"));
